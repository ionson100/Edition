       ...
       try{
        ...
        tinyMCE.init({
            ...
            //template_external_list_url: "#root#/Foto/templates/template_list.js",
            ...
            template_templates: [
                {
                    title: "JQuery плагин Акардеон",
                    src: "#root#/Foto/templates/layout1.htm",
                    description: "Adds Editor Name and Staff ID"
                },
                {
                    title: "JQuery плагин Акардеон нет автовысоты",
                    src: "#root#/Foto/templates/snippet1.htm",
                    description: "Adds an editing timestamp."
                },
                {
                    title: "Tabs JQueryUI",
                    src: "#root#/Foto/templates/t2.htm",
                    description: "Adds an editing timestamp."
                },
                {
                    title: "FAQ",
                    src: "#root#/Foto/templates/t3.htm",
                    description: "Adds an editing timestamp."
                }
