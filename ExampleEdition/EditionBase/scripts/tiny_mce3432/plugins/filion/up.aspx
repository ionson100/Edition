...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            imgPath = "/ImagesEditors";
            path = HttpContext.Current.Server.MapPath("~/ImagesEditors");
            Imgpath = "/ImagesEditors/";
        }
        else
        {
             path = HttpContext.Current.Server.MapPath("~/ImageEditor");
             imgPath = "/ImageEditor";
             Imgpath = "/ImageEditor/";
        }
                ...
                menu: 'myMenu'
					...
					function (action, el, pos) {
					    ...
					    if (action == "paste") {
					        ...
					        try {
					            tinyMCEPopup.execCommand('mceInsertContent', true, dom.createHTML('img', {
					                src: path.replace('#', '').replace('paste', '') + $(el).attr('id'),
					                alt: "",
					                title: "",
					                border: 0
					            }));
